...
function updateAll(dt, playerPosition) {
    ...
    for (const [, m] of _monsters) {
        ...
        const dist = m.mesh.position.distanceTo(playerPosition);
        if (dist > 40) {
